...
version: 1.0.0
description: |
  Panel review of a paper draft. Assembles the Referee, Theorist, and Postdoc
  to debate the paper's claims, methodology, clarity, and physics. Three rounds
...
|------|-------------|-------|
| Referee | `personas/referee.md` | Systematic review: claims supported? Stats correct? Comparisons adequate? |
| Theorist | `personas/theorist.md` | Physics: derivations correct? Limiting cases checked? Dimensional consistency? |
| Postdoc | `personas/postdoc.md` | Clarity: can a non-expert follow? Steps skipped? Jargon unexplained? |
